#  .rs.restartR()
    ...
    this_file = "mi-test-mgAmelia-BigB.R"
    ...
    # Gaby
      ...
      #temp_dir = "C:/Users/Gaby/Documents/zip-temp" #  Temporary directory for local maching (will automaticall add new temporary folder)      
      #Rdata_dir = "C:/Users/Gaby/Documents/zip-temp"
    ...
    # Define the imputation alogrithms to compare
      pva_vec = c(2,12,13,14) #c(10,11,12,13,14)
...
#      methods_list$procedure[[11]] = "stratamelia";     methods_list$name[[11]] = "strata-Amelia-weak";      methods_list$args[[11]] = list(m = M, p2s = as.numeric(VerboseImpute), tolerance = 1E-4, empri = 0.005)
      methods_list$procedure[[2]] = "stratamelia";     methods_list$name[[2]] = "strata-Amelia-moder";      methods_list$args[[2]] = list(m = M, p2s = as.numeric(VerboseImpute), tolerance = 1E-4, empri = 0.01)
      methods_list$procedure[[3]] = "stratamelia";     methods_list$name[[3]] = "strata-Amelia-strong";     methods_list$args[[3]] = list(m = M, p2s = as.numeric(VerboseImpute), tolerance = 1E-4, empri = 0.05)
      methods_list$procedure[[4]] = "stratamelia";     methods_list$name[[4]] = "strata-Amelia-verystr";    methods_list$args[[4]] = list(m = M, p2s = as.numeric(VerboseImpute), tolerance = 1E-4, empri = 0.1)
...
#                  print("  >> list_imputed constructed")
                  ...
                  obj_smi_pva2 = sem.mi(model = form_lavaan, 
                                         data = mids2datlist(list_imputed$obj_call$pm1$pva2),
                                         group = "subpop",
                                         estimator = "ml", information = "observed")
                 ...
                 vars_keep = c("lhs","op","rhs","group","est","se")
                  ...
                  df_pva2 = obj_smi_pva2 %>% summary() %>% data.frame() %>% select(vars_keep) %>% transform(rep=rep,z=z,pva=2,type="Imputed")
                  ...
                  sim_df = rbind(df_complete, df_pva2, df_pva12, df_pva13, df_pva14)
                  save(sim_df, file = paste0(lists_wd,"/result-test-mgAmelia rep",rep, " z",z,".Rdata"))
