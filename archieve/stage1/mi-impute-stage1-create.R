#  .rs.restartR()
    ...
    RndSeed = 42
    VerboseImpute = FALSE
    stage0_zip = "Rdata-mi-impute-stage0 Jan 06 2019 13 29.zip" #z1-z40 and pm1
   ...
   # Queen Mary's Revenge
      ...
      #temp_dir = "D:/lpa-mi-impute" #"C:/Users/marcu/Documents/lpa-mi-impute" #  Temporary directory for local maching (will automaticall add new temporary folder)
    # Xi-GSU
    ...
    # Gaby
      ...
      temp_dir = "C:/Users/Gaby/Documents/lpa-mi-impute-create"

    # Create "zip folder" where environments will be saved
      Rdata_dir = "E:/" 
    ...
    # Define the imputation alogrithms to compare
      ...
      methods_list$procedure[[1]] = "mice";           methods_list$name[[1]] = "CART";         methods_list$args[[1]] = list(method = "cart", maxit = 50, m = M, printFlag = VerboseImpute)
      #methods_list$procedure[[5]] = "mice";           methods_list$name[[5]] = "RF";           methods_list$args[[5]] = list(method = "rf", ntree = 10, m = M, printFlag = VerboseImpute)
    ...
    # Create folder name for temporary folder (saved in results and in temp files)
      temp_fname = paste("mi-impute-stage1-create", format(Sys.time(), "%b %d %Y %H %M"), sep = " ")
