#  .rs.restartR()
    ...
    this_file = "mi-impute-stage1-create.R"
    ...
    # IQSS RCE NoMachine
      ...
      #temp_dir = "/nfs/home/M/mwaldman/diss-nomx"
      #Rdata_dir = temp_dir
      #unzip_dir = temp_dir
    # Queen Mary's Revenge
      dropbox_wd = "D:/Dropbox"
      temp_dir = "C:/Users/marcu/Documents/lpa-mi-impute/stage0"
      Rdata_dir = "C:/Users/marcu/Documents/lpa-mi-impute/stage0"
      unzip_dir = "C:/Users/marcu/Documents/lpa-mi-impute/stage0"
    ...
    # Fully-crossed simulation conditions
      ...
      N_vec = c(1200)                       #  Sample sizes within each replication (small - 300, large - 1200)
      ...
      MD_vec = c(3.7)                       #  Mahalanobis disance separating classes (low - 2.87, high = 3.70)
      ...
      dX_vec = c(TRUE)                    #  Between class differences in missing data correlates, Cohen's d
    ...
    # Define the imputation alogrithms to compare
      ...
      #methods_list$procedure[[4]] = "mice";          methods_list$name[[4]] = "RF";           methods_list$args[[4]] = list(method = "rf", ntree = 10, m = M, printFlag = VerboseImpute)
      methods_list$procedure[[1]] = "EMs_LPA";        methods_list$name[[1]] = "EMs-LPA";      methods_list$args[[1]] = list(M = M, tempdir_mplus = "C:/Users/marcu/Documents/lpa-mi-impute/stage0")
      #methods_list$procedure[[]] = "mice";           methods_list$name[[]] = "MVN";          methods_list$args[[]] = list(blocks = list(block_y = c("Y1","Y2","Y3"), block_x = c("Xcom1")), method = "norm", maxit = 5E1, m = M, printFlag = VerboseImpute)
      #methods_list$procedure[[]] = "mice";           methods_list$name[[]] = "PMM-MT";       methods_list$args[[]] = list(method = "midastouch", maxit = 50, m = M,  printFlag = VerboseImpute)
      #methods_list$procedure[[]] = "parlmice";       methods_list$name[[]] = "CART";         methods_list$args[[]] = list(n.core = 4, n.imp.core = M/Processors, method = "cart", maxit = 20, m = M, printFlag = VerboseImpute)
      #methods_list$procedure[[]] = "amelia";         methods_list$name[[]] = "mg-Amelia";    methods_list$args[[]] = list(m = M, p2s = as.numeric(VerboseImpute), tolerance = 1E-4, cs = "subpop", intercs = TRUE, empri = 0.01)
