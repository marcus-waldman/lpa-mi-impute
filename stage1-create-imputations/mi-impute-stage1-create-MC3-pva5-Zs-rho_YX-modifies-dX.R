#*****NOTE THAT THIS CODE ASSUMES THAT STAGE0 LISTS ARE EXTRACTED AND READY TO GO*************
    ...
    ######################################################################################################################
    Processors = 10
    this_file = "mi-impute-stage1-create-MC3-pva5-Zs-rho_YX-modifies-dX.R"
    ...
    # Gaby/MC/QMR
      ...
      stage0_dir = "E:/Rdata-mi-impute-stage0"
    ...
    zvec =which(with(data_conditions, rho_YX == 0.4 & C_modifies_YX == TRUE & dX == TRUE))
