    ...
    pctmiss_vec = c(0.35,0.5)     #  Percent of observations with *at least* one missing value (indicator or missing data correlate) -> if other specification needed one must modify list_inds.miss generation in get_obs_data.R
    ...
    MD_vec = c(2.75, 3.25, 4.00)               #  WARNING! MD = 1 RESULTS IN ERROR! Mahalanobis distances between classes
